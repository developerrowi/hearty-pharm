<script>
    ...
    import { storeSelectedProduct, updateProduct, getProducts, deleteProductItem } from "$lib/supabase-api"
          ...
          <div class="max-w-xs px-10">
              ...
              <form class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                  ...
                  <input 
                    bind:value={$storeSelectedProduct.name} 
                ...
                <div class="mb-4">
                  ...
                  <input
                    bind:value={$storeSelectedProduct.price} 
                ...
                <div class="mb-4">
                  ...
                  <input
                    bind:value={$storeSelectedProduct.supplier_price}  
                ...
                <div class="mb-4">
                  ...
                  <input
                    bind:value={$storeSelectedProduct.category}  
                ...
                <div class="mb-4">
                  ...
                  <input 
                    bind:value={$storeSelectedProduct.qty} 
